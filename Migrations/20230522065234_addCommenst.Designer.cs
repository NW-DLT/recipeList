...
namespace recipeList.Migrations
{
    ...
    [Migration("20230522065234_addCommenst")]
    partial class addCommenst
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("recipeList.Models.comment", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("recipeList.Models.Like", b =>
                {
                    b.HasOne("recipeList.Models.Recipe", "Recipe")
                        .WithMany("likes")
            ...
            modelBuilder.Entity("recipeList.Models.User", b =>
                {
                    b.HasOne("recipeList.Models.Image", "Image")
                        .WithMany()
